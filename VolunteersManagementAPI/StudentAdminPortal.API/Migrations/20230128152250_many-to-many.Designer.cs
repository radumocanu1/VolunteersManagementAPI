...
namespace VolunteersManagement.API.Migrations
{
    ...
    [Migration("20230128152250_many-to-many")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VolunteersManagement.API.Models.ManyToMany", b =>
                {
                    b.Property<Guid>("VolunteerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VolunteersManagement.API.Models.ToDo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VolunteersManagement.API.Models.ManyToMany", b =>
                {
                    b.HasOne("VolunteersManagement.API.Models.ToDo", "toDo")
                        .WithMany("manyToMany")
                        .HasForeignKey("ToDoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VolunteersManagement.API.Models.Volunteer", "volunteer")
                        .WithMany("manyToMany")
